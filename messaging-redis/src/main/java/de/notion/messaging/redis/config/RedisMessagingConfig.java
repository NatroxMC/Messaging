...
import de.notion.messaging.redis.RedisMessaging;
...
public class RedisMessagingConfig implements MessagingConfig {
    ...
    public RedisMessagingConfig(boolean useCluster, String password, String... addresses) {
    ...
    @Override
    public MessagingService<?> construct(String serviceName, String senderName) {
        return new RedisMessaging(serviceName, senderName, redissonClient);
    }
}
